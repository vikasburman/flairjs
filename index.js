...
let MyMixin = Mixin('MyMixin', function() {
    $$('override');
    this.prop1 = 102;
});


let MyMixin2 = Mixin('MyMixin2', function() {
    $$('override');
    this.prop1 = 204;
});
...
let MyClass2 = Class('MyClass2', MyClass, [MyMixin, MyMixin2], function() {
    this.prop4 = 30;

    $$('override');
    this.construct = (base) => {
        base();
        console.log('In MyClass2');
    };

    $$('static');
    this.staticPropChild = 30;

    $$('static');
    this.staticFuncChild = function() {
        console.log(this.staticPropChild);
    };
});
let yy = new MyClass2();
let yyy = new MyClass2();
...
let MyStaticClass2 = Class('MyStaticClass', function() {
    this.prop1 = 20;
    this.abc = function() {
        console.log(MyStaticClass.prop1);
    };
});
...
let MyEnum = Enum('MyEnum', function() {
    this.prop1 = 10;
});
console.log(MyEnum);
    ...
    //     console.log(a1);
    // })
    // window.myProc = myProc;

    var Mix1 = Mixin('core.test.abc.Mix1', function() {
        this.func('mixed1', () => {
            console.log(this);
        });
    });
    var Mix2 = Mixin('core.test.abc.Mix2', function() {
        this.func('mixed2', () => {
            console.log(this);
        });
    });
    ...
    // define classes
    var Vehicle = Class('core.test.abc.Vehicle', [Mix1, Mix2, ITest, ITest2], function(attr) {
        //attr('abstract');
        this.func((cc) => {
    ...
    window.Config = Resource('Config', '', btoa('{ "abc": true }'));
    ...
    var BMW = Class('BMW', Car, function(attr) {
        ...
        attr('conditional', 'DEBUG');
        this.func('func6', (x) => {
            console.log('I am func 6 with: ' + x);
            return x;
        });

    });

    Aspects.register('BMW:func*/conditional', Class('ElapsedTime', Aspect, function() { 
        this.before((ctx) => {
...
//     ], (Vikas, fs, obj) => {
//         Class('a.b.c.Car', Vikas, function() {
