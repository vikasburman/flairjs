...
(async () => { // ./src/flair.vue/flair.ui.vue/@1-VueComponentMembers.js
try{
...
(async () => { // ./src/flair.vue/flair.ui.vue/VueComponent.js
try{
...
(async () => { // ./src/flair.vue/flair.ui.vue/VueDirective.js
try{
/**
 * @name VueDirective
...
(async () => { // ./src/flair.vue/flair.ui.vue/VueFilter.js
try{
/**
 * @name VueFilter
...
(async () => { // ./src/flair.vue/flair.ui.vue/VueLayout.js
try{
/**
 * @name VueLayout
...
(async () => { // ./src/flair.vue/flair.ui.vue/VueMixin.js
try{
/**
 * @name VueMixin
...
(async () => { // ./src/flair.vue/flair.ui.vue/VuePlugin.js
try{
/**
 * @name VuePlugin
...
(async () => { // ./src/flair.vue/flair.ui.vue/VueSetup.js
try{
...
(async () => { // ./src/flair.vue/flair.ui.vue/VueView.js
try{
...
AppDomain.registerAdo('{"name":"flair.vue","file":"./flair.vue{.min}.js","mainAssembly":"flair","desc":"True Object Oriented JavaScript","title":"Flair.js","version":"0.50.48","lupdate":"Sun, 05 May 2019 03:02:57 GMT","builder":{"name":"<<name>>","version":"<<version>>","format":"fasm","formatVersion":"1","contains":["initializer","functions","types","enclosureVars","enclosedTypes","resources","assets","routes","selfreg"]},"copyright":"(c) 2017-2019 Vikas Burman","license":"MIT","types":["flair.ui.vue.VueComponentMembers","flair.ui.vue.VueComponent","flair.ui.vue.VueDirective","flair.ui.vue.VueFilter","flair.ui.vue.VueLayout","flair.ui.vue.VueMixin","flair.ui.vue.VuePlugin","flair.ui.vue.VueSetup","flair.ui.vue.VueView"],"resources":[],"assets":[],"routes":[{"name":"flair.ui.vue.test2","mount":"main","index":101,"verbs":[],"path":"test/:id","handler":"abc.xyz.Test"},{"name":"flair.ui.vue.exit2","mount":"main","index":103,"verbs":[],"path":"exit","handler":"abc.xyz.Exit"}]}');
