...
(async () => { // ./src/flair.app/(root)/@1-Bootware.js
'use strict';
/**
 * @name Bootware
...
(async () => { // ./src/flair.app/(root)/@2-Host.js
'use strict';
...
(async () => { // ./src/flair.app/(root)/@3-App.js
'use strict';
const { IDisposable } = ns();
const { Bootware } = ns('flair.app');
