...
describe('---- index.js ----', () => {
    describe('Load:', () => {
        ...
        describe('Init:', () => {
            ...
            it('should define flair members', () => {
                expect(flair.Exception).toBeDefined();
                expect(flair.Enum).toBeDefined();
                expect(flair.Class).toBeDefined();
                expect(flair.Reflector).toBeDefined();
            });        
            ...
            describe('Re-Init (Without Globals):', () => {
                ...
                it('should still define flair members', () => {
                    expect(flair.Exception).toBeDefined();
                    expect(flair.Enum).toBeDefined();
                    expect(flair.Class).toBeDefined();
                    expect(flair.Reflector).toBeDefined();
